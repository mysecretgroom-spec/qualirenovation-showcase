...
const SITE_DEDIE_URL = "https://renovermasalledebain.com/partenaires/contact";
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
              <div className="container-tight">
                <h1 className="font-display text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-semibold text-background leading-tight mb-4">
                  ...
                  <span style={{ fontFamily: "'Edwardian Script ITC', cursive" }} className="text-[1.1em]">salle de bain</span>
                </h1>
